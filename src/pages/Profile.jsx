    ...
    return (
        ...
        <div className='flex flex-row justify-between items-stretch'>
            <div className='ml-10 w-[100%]'>
                <h1 className='text-4xl text-white font-bold text-left'>{name.charAt(0).toUpperCase() + name.substring(1)}</h1>
                <hr className='text-white w-[90%] mt-2' />

                <div className='text-xl text-white font-bold mt-8 text-left'>Sex: {data?.sex == 1 ? "Male" : "Female"}</div>

                <div className='text-md text-white mt-2 text-left'>Your Last Report</div>
                ...
                <div className="grid grid-cols-2 mt-2 border-2 border-white rounded mr-5">
                    <div className='grid grid-cols-2 border-r align-items-center border-b-2 border-gray-500 p-2'>
                        ...
                        <div className='text-gray-400 text-left'>{data?.age ? data.age : ""}</div>
                    </div>
                    ...
                    <div className='grid grid-cols-2 gap-2 align-items-center border-b-2 border-gray-500 p-2'>
                        ...
                        <div className='text-gray-400 text-left'>{data?.cp ? data.cp : ""}</div>
                    </div>

                    <div className='grid grid-cols-2 gap-2 align-items-center border-r border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left '>Resting blood pressure</div>
                        <div className='text-gray-400 text-left'>{data?.trestbps ? data.trestbps : ""}</div>
                    </div>

                    <div className='grid grid-cols-2 gap-2 align-items-center border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>Cholestoral</div>
                        <div className='text-gray-400 text-left'>{data?.chol ? data.chol : ""}</div>
                    </div>

                    <div className='grid grid-cols-2 gap-2 align-items-center border-r border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>Fasting blood sugar</div>
                        <div className='text-gray-400 text-left'>{data?.fbs ? data.fbs : ""}</div>
                    </div>

                    <div className='grid grid-cols-2 gap-2 align-items-center border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>Resting ECG</div>
                        <div className='text-gray-400 text-left'>{data?.restecg ? data.restecg : ""}</div>
                    </div>
                    <div className='grid grid-cols-2 gap-2 align-items-center border-r border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>Max. Heart rate</div>
                        <div className='text-gray-400 text-left'>{data?.thalach ? data.thalach : ""}</div>
                    </div>

                    <div className='grid grid-cols-2 gap-2 align-items-center border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>Exercise induced pain</div>
                        <div className='text-gray-400 text-left'>{data?.exang ? data.exang : ""}</div>
                    </div>
                    <div className='grid grid-cols-2 gap-2 align-items-center border-r border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>Slope</div>
                        <div className='text-gray-400 text-left'>{data?.slope ? data.slope : ""}</div>
                    </div>

                    <div className='grid grid-cols-2 gap-2 align-items-center border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>CA</div>
                        <div className='text-gray-400 text-left'>{data?.ca ? data.ca : ""}</div>
                    </div>
                    <div className='grid grid-cols-2 gap-2 align-items-center border-r border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>Thalassemia</div>
                        <div className='text-gray-400 text-left'>{data?.thal ? data.thal : ""}</div>
                    </div>

                    <div className='grid grid-cols-2 gap-2 align-items-center border-b-2 border-gray-500 p-2'>
                        <div className='text-white text-left'>ST Depression</div>
                        <div className='text-gray-400 text-left'>{data?.oldpeak ? data.oldpeak : ""}</div>
                    </div>
                </div>
